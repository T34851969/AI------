...
- [**AI工具使用文档 V1.2**](#ai工具使用文档-v12)
  ...
  - [**8 学习资源**](#8-学习资源)
    ...
    - [8.4 学习建议](#84-学习建议)
  - [**9 Vibe Coding**](#9-vibe-coding)
    - [9.1 为什么可以 Vibe Coding 了？](#91-为什么可以-vibe-coding-了)
  - [**10 补充**](#10-补充)
...
氛围编程（Vibe Coding）大约是在 2024 年的下半年逐渐成型的，此时的 LLM 已经初具规模（GPT-4o 已经可以胜任部分简单的工作）。不过它真正出现是在 2025 年 2 月份，由前特斯拉 AI 总监、OpenAI 联合创始人 Andrej Karpathy 首次提出。简单讲，它就是“用 AI 写代码”的专名。

Andrej Karpathy 如此描述 Vide Coding：

> 一种全新的编码方式，你完全沉浸在氛围中，拥抱指数级的效率提升，甚至忘记代码本身的存在

到了今年这个时候，LLM 已经成为编程活动的基础设施，重要性不言而喻，就连 Linux 内核代码树都多出很多使用 AI 提交的补丁（但很多已经被 Linus 驳回，因为它们欠缺内核代码特殊的考量）。由此催生出一系列关于 Vibe Coding 的方法、最佳实践、规范等等。在此作简单讲解。

### 9.1 为什么可以 Vibe Coding 了？

**首先，依然是 LLM 基座的进步，它们能够生成更好的东西。**
