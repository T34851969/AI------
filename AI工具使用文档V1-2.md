...
- 目前为止，将该网站打印为 PDF 会出现奇怪的排版问题，暂时不能解决，若有本地查看需求，直接保存该 `.html` 文件并使用浏览器查看
...
- [**AI工具使用文档 V1.2**](#ai工具使用文档-v12)
  ...
  - [**8 学习资源**](#8-学习资源)
    ...
    - [8.4 学习建议](#84-学习建议)
  - [**9 一些其它的概念**](#9-一些其它的概念)
    - [9.1 Vibe Coding](#91-vibe-coding)
      - [9.1.1 为什么可以 Vibe Coding 了？](#911-为什么可以-vibe-coding-了)
      - [9.1.2 Vibe Coding 参考](#912-vibe-coding-参考)
      - [9.1.3 一点提醒](#913-一点提醒)
  - [**10 补充**](#10-补充)
...
**重要提醒**：使用ChatGPT辅助写作，必须遵守学术规范，确保AI使用的合规性，规范引用并明确说明自身如何使用ChatGPT。善用AI工具，使其成为学习中的得力助手，而非替代独立思考的捷径。

**链接**：<https://openai.com/chatgpt/use-cases/student-writing-guide/>

### 2.2 西南交通大学 —— 《生成式AI写作指南V1.0》

《生成式AI写作指南V1.0》由西南交通大学多学科专家团队撰写，于2024年10月发布。该指南分三部分，旨在为高校及社会运用生成式AI写作提供参考和指导。以下是其内容的基本介绍：
...
随着通用大模型的日益成熟，有些时候不再需要严格遵循模板来构思提示词，AI工具已能够深入理解用户需求，并进行自主解析与细化。然而，深入理解提示词的核心逻辑依然至关重要。“提示词工程师”如此迅速的兴起与消亡提醒我们，“提示工程”已经从一种职业能力转变为专业素养 —— 就像外语之于专业/职业一样，并最终会向“通用素养”这个方向发展。
...
**氛围编程**（Vibe Coding）大约是在 2024 年的下半年逐渐成型的，此时的 LLM 已经初具规模（GPT-4o 乃至 4.1 已经可以胜任部分简单的工作）。不过它真正出现是在 2025 年 2 月份，由 OpenAI 联合创始人 Andrej Karpathy 首次提出。简单讲，它就是“用 AI 写代码”的专名。

Andrej Karpathy 如此描述 Vide Coding：
...
#### 9.1.1 为什么可以 Vibe Coding 了？

- **LLM 基座的进步**
它们一直生成更好的东西。可以参考 [BenchLM](https://benchlm.ai/benchmarks/sweVerified)，这个网站记载了从24年起各主流 LLM 的编程水平。

- **编程工具向 LLM 对齐**
起初人们只能通过网页端聊天使用 AI，效率低下。现在 Cursor 这样原生集成 AI 的开发环境很多了。

- **Agent**
直到 Agent 出现，我们才有机会让 LLM 介入操作系统操作：执行文件读写、编写代码、运行测试并自行迭代修复，支持多步骤自动化工作流

#### 9.1.2 Vibe Coding 参考
...
- **步步为营**
LLM 无法在单次会话里处理过于复杂的问题，也就是说，不能将项目文档几千字地扔给 LLM。这么做的后果，是花费数倍于**分批次描述**的时间检查其业务代码。

- **要懂代码**
别读完 LLM 写的代码，但一定要做人工审查，尤其关注以下几个方面：
  1. 是否符合团队的编码规范
